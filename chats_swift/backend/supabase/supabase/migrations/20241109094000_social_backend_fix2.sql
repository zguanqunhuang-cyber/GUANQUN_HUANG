-- Recreate friend functions with unambiguous column references
...
begin
    ...
    if request_record.addressee_id is distinct from respond_friend_request.responder_id then
